# 🚢 Ship-It-Bounties: 去中心化 AI 产品孵化实验
...
我们是一个**盈利稳定（月毛利 4W+）、现金流健康**的独立开发组织。

目前，我们积压了 30+ 个经过市场验证的 AI 落地想法（涉及母婴、图像处理、SaaS 等领域），但受限于开发人力，无法全部落地。
...
我们需要你通过我们的专属协作工具 —— **微信小程序 [Ship It]** 来领取任务和提交代码。
